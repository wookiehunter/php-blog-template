...
$query = "UPDATE comments SET com_status = '{$bulk_options}' WHERE com_id = {$commentValueId}  ";
...
$query = "DELETE FROM comments WHERE com_id = {$commentValueId}  ";
...
<input type="submit" name="submit" class="btn btn-success" value="Apply">
  ...
  <?php 
    ...
    $query = "SELECT * FROM comments WHERE com_post_id =" . mysqli_real_escape_string($connection,$_GET['id']). " ";
    $select_comments = mysqli_query($connection,$query);  

    while($row = mysqli_fetch_assoc($select_comments)) {
        $comment_id         = $row['com_id'];
        $comment_post_id    = $row['com_post_id'];
        $comment_author     = $row['com_author'];
        $comment_content    = $row['com_content'];
        $comment_email      = $row['com_email'];
        $comment_status     = $row['com_status'];
        $comment_date       = $row['com_date'];
...
if(isset($_GET['approve'])){
    ...
    $query = "UPDATE comments SET com_status = 'approved' WHERE com_id = $the_comment_id   ";
...
if(isset($_GET['unapprove'])){
    ...
    $query = "UPDATE comments SET com_status = 'unapproved' WHERE com_id = $the_comment_id ";
